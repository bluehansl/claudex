...
When `--package claudex` is provided, the staging helper builds the lightweight
`@bluehansl/claudex` meta package plus all platform-native `@bluehansl/claudex` variants
